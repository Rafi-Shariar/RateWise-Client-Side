      ...
      {loader ? (
        ...
        <>
          <div className="mt-10 p-2">
            <div className="flex justify-center items-center max-w-4xl mx-auto p-2 gap-5">
              ...
              <div className="flex flex-col justify-evenly">
                ...
                <h1 className="badge p-4 lg:text-lg lg:mt-3">
                  <RiHomeOfficeFill />
            ...
            <div className="max-w-4xl mx-auto bg-base-200 p-5 mt-10 rounded-2xl">
              ...
              <div className="mt-6">
                <p className="badge mr-5 font-extralight">
                  Created At: {serviceData.addedDate}
                </p>
                <p className="badge font-extralight">
                  Created By: {serviceData.userEmail}
                </p>
              </div>
            </div>
          </div>
          ...
          <section className="p-2">
            <div className="flex flex-col-reverse lg:flex-row gap-10 mb-20 bg-slate-100 rounded-2xl p-5 md:p-10">
              {/* User Review Section */}
              <section className=" lg:w-2/3">
                <div className="text-3xl mb-5 text-blue-900 flex items-center gap-3">
                  <h1>Reviews</h1>

    ...
    <div>
      ...
      >
        ...
        <p className="font-extralight mt-3">
          Tracking service activity, user engagement, and feedback.
        </p>
      </motion.div>

      {/* Matrices */}
      <div className="my-10 justify-center gap-7 bg-slate-100 py-20 px-2 rounded-2xl">
        {/* Services */}
        <div className="max-w-5xl mx-auto grid lg:grid-cols-3 gap-6">
            <div className="flex flex-col justify-center items-center bg-gradient-to-br from-white via-green-50 to-green-200 shadow-lg p-8 rounded-2xl border border-green-300  shadow-gray-400">
        ...
        <div className="flex flex-col justify-center items-center bg-gradient-to-br from-white via-orange-50 to-orange-200 shadow-lg p-8 rounded-2xl border border-orange-300  shadow-gray-400 ">
        ...
        <div className="flex flex-col justify-center items-center bg-gradient-to-br from-white via-yellow-50 to-yellow-100 shadow-lg p-8 rounded-2xl border border-yellow-300  shadow-gray-400">
